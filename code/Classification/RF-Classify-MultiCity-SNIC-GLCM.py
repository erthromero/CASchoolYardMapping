...
def applyClassifier(image_path: str, modelPath: str,
    ...
    #NOTE (Eric): Read in the random forest classifier
    ...
    if not isfile(subsetShapefile):
        ...
        predicted = RFModel.predict(objects)
...
def main():
    ...
    model_path = "E:\\SummerGSR2024\\MLModels\\LA-Oak-Sac\\LA-Oak-Sac-SchoolYards-MoreStats-SNIC-GLCM-RF.joblib"    
